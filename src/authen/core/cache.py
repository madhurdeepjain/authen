...
class MemoryCache(CacheBackend):
    ...
    Good for short-lived caching within a single session.
    """
    ...
    def __init__(self, default_ttl: int = 3600, max_size: int = 1000):
        ...
        self._cache: dict[str, tuple[dict, float]] = {}  # key -> (value, expiry_time)
    ...
    def _evict_oldest(self) -> None:
        ...
        # Sort by expiry time (None expiry = infinite, treat as max)
        items = sorted(
            self._cache.items(),
